...
from src.api.routers import auth, projects, scripts, keyframes, videos, files, models, system_config, hotspots, timelines, tts, medeo
...
def create_application() -> FastAPI:
    ...
    app.include_router(medeo.router, prefix="/api/medeo", tags=["Medeo"])
